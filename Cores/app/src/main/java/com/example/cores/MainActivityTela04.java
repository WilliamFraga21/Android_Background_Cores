...
public class MainActivityTela04 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnTrocarTela.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(MainActivityTela04.this, MainActivityTela04.class);
        ...
        btnTrocarTelaVoltando.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // Crie um Intent para iniciar a nova atividade
                Intent intent = new Intent(MainActivityTela04.this, MainActivityTela3.class);
